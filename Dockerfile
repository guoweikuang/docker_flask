...
LABEL maintainer="weikuang.guo" \
      ...
      io.daocloud.dce.plugin.rules="[{'apiGroups': [""], 'resources': ['nodes', 'secrets', 'apps', ''], 'verbs': ['get','watch', 'list']}, {'apiGroups': [''], 'resources': ['staticip', 'nodes', 'persistentvolumes', 'dcepluginsmanagement'], 'verbs': ['get', 'list', 'update', 'patch', 'create', 'delete']}]"
