...
LABEL maintainer="weikuang.guo" \
      ...
      io.daocloud.dce.plugin.rules="[{'apiGroups': [""], 'resource': ['nodes', 'secrets', 'apps', ''], 'verbs': ['get','watch', 'list']}, {'apiGroups': [''], 'resource': ['staticip', 'nodes', 'persistentvolumes', 'dcepluginsmanagement'], 'verbs': ['get', 'list', 'update', 'patch', 'create', 'delete']}]"
